...
public class Adapter extends RecyclerView.Adapter<Adapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull viewholder holder, @SuppressLint("RecyclerView") int position) {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setNegativeButton("YA", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        db.deleteData(dataholder.get(position).getUsername());
        ...
        holder.button_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("email", dataholder.get(position).getEmail());
                bundle.putString("gender", dataholder.get(position).getJenis_kelamin());
                bundle.putString("grup", dataholder.get(position).getKondisi_kesehatan());
    ...
    class viewholder extends RecyclerView.ViewHolder{
        TextView username, email, name, is_valid;
        Button button_delete, button_update;
        public viewholder(@NonNull View itemView){
            super(itemView);
            name = (TextView) itemView.findViewById(R.id.inputNama);
            email = (TextView) itemView.findViewById(R.id.inputEmail);
